...
export const NOTIF_TYPE_SUCCESS = "success";
export const NOTIF_TYPE_ERROR = "error";
export const NOTIF_TYPE_LOADING = "loading";
export const NOTIF_TYPE_INFO = "info";
export const NOTIF_TYPE_LONG = "long";
